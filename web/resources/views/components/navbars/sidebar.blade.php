...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('homepage') }} ">
            <img src="{{ asset('assets') }}/img/logos/favicon.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-2 font-weight-bold text-white">Math Challenge 2024</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main" style="height: 100vh">
        <ul class="navbar-nav h-100">
            ...
            <li class="nav-item mt-5">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Schools</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'schools' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('schools.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1.2rem;" class="fas fa-school ps-2 pe-2 text-center"></i>
                    </div>
                    <span class="nav-link-text ms-1">View schools</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'create-school' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('schools.create') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1.2rem;" class="fas fa-plus ps-2 pe-2 text-center"></i>
                    </div>
                    <span class="nav-link-text ms-1">Add schools</span>
                </a>
            </li>
            
            <li class="nav-item mt-5">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Challenges</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'challenges' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('challenges') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1.2rem;" class="fas fa-folder ps-2 pe-2 text-center"></i>
                    </div>
                    <span class="nav-link-text ms-1">View challenges</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'create-challenge' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('create-challenge') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1.2rem;" class="fas fa-folder-plus ps-2 pe-2 text-center"></i>
                    </div>
                    <span class="nav-link-text ms-1">Add challenges</span>
                </a>
            </li>
